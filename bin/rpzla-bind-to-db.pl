...
rpz-log-bind-to-db.pl - read the output from rpz-log-bind-filter.pl and insert the data into a database

=head1 SYNOPSIS

        rpz-log-bind-to-db.pl <-h|-m|-V>
or
        rpz-log-bind-to-db.pl <-c path-to-config-file>

=head1 DESCRIPTION

rpz-log-bind-to-db.pl reads the output from the rpz-log-bind-filter.pl
